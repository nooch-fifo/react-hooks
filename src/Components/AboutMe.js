    ...
    return (
        <div class="container">
            ...
            <section style={{ padding: 15 }}>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <p class="text-dark" style={{ marginTop: 5, fontSize: 17}}>As a junior software engineer and UX design enthusiast, I’m passionate about creating cutting-edge designs
